...
public class NokiaPhoneSimulationWithSwitchCase {
    public static void main(String[] args) {
        Scanner inputCollector = new Scanner(System.in);

        String prompt = """
                Welcome to Nokia 3310 Phone Menu.
                Follow the below instruction to make most or great use of the app.
        ...
        switch (userInput) {
            case 1 -> {
                ...
                System.out.print("Select option: ");
                int subUserInput1 = inputCollector.nextInt();

                switch (subUserInput1) {
                    case 1 -> System.out.println("Searching phone book");
                    case 2 -> System.out.println("Service Number in phone book");
                    case 3 -> System.out.println("Adding name to phone book");
                    case 4 -> System.out.println("Erasing name in phone book");
                    case 5 -> System.out.println("Editing name in phone book");
                    ...
                    case 8 -> {
                        ...
                        System.out.print("Select option: ");
                        int subUserInput2 = inputCollector.nextInt();

                        switch (subUserInput2) {
                    ...
                    case 7 -> {
                        ...
                        switch (subUserInput2) {
                            case 1 -> {
                                ...
                                System.out.print("Select option: ");
                                int subUserInput3 = inputCollector.nextInt();

                                switch (subUserInput3) {
            ...
            default -> System.out.println("Invalid option. Please select from the menu.");
        }
